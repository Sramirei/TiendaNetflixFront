...
const PlexTable = () => {
  ...
  headers: {
    ...
    const pageNumbers = [];
    for (let i = 1; i <= Math.ceil(filteredAccount.length / accountPerPage); i++) {
      pageNumbers.push(i);
    }
        ...
        <div className="TableContainer">
          <div className="wrapper">
            <div className="panel-table">
              ...
              <button className="create" onClick={() => createAccounts()}>Crear Cuenta</button>
            </div>
            ...
            <div className="table">
              ...
              {loading ? (
                <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "20em" }}>
                  <PacmanLoader
                    color="#000000"
                    loading={loading}
                    size={30}
